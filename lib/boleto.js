...
const moment = require('./moment-brt')
...
Boleto.prototype.renderHTML = function (callback) {
  ...
  var renderOptions = Object.assign({}, self.bank.options)
  ...
  var pixPayload = self['pix_copia_cola'] || self['pixCopiaCola']
  var shouldRenderPixQr = self['banco'] === 'bradesco' &&
